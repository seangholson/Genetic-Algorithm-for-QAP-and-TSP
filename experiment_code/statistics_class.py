...
class ExperimentStatistics:
    ...
    def __init__(self, results_dict=None):
        ...
        self.solver = self.results_dict['solver, size, experiment type, problem type, instance, save_csv bool, answer'][0]
        self.size = self.results_dict['solver, size, experiment type, problem type, instance, save_csv bool, answer'][1]
        self.experiment_type = self.results_dict['solver, size, experiment type, problem type, instance, save_csv bool, answer'][2]
        self.problem_type = self.results_dict['solver, size, experiment type, problem type, instance, save_csv bool, answer'][3]
        self.instance = self.results_dict['solver, size, experiment type, problem type, instance, save_csv bool, answer'][4]
        self.save_csv = self.results_dict['solver, size, experiment type, problem type, instance, save_csv bool, answer'][5]
        self.answer = self.results_dict['solver, size, experiment type, problem type, instance, save_csv bool, answer'][6]
        ...
        self.max_fitness_arrays = self.results_dict['max_fitness_array']
    ...
    def run_stats(self):
        ...
        if self.save_csv and int(self.size) == 20:
            ...
            len_convergence_vec = (len(self.max_fitness_arrays[0])-1)/5
            convergence_vec = []
            ...
            for vec in self.max_fitness_arrays:
